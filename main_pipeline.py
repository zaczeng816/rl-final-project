...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_games_per_MCTS_process", type=int, default=40, help="Number of games to simulate per MCTS self-play process")
    ...
    parser.add_argument("--num_reads_MCTS", type=int, default=600, help="Number of MCTS reads")
